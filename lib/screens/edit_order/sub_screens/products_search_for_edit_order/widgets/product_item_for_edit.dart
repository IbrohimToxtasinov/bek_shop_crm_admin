      ...
      builder: (context, productPriceState) {
        if (productPriceState is GetProductsCostSuccess) {
          return BlocBuilder<OrderEditCartBloc, OrderEditCartState>(
            buildWhen:
                (previous, current) => current is OrderEditCartGetSuccess,
                      ...
                      if (exists.isNotEmpty) {
                              ...
                              builder: (BuildContext context) {
                                return ProductDetailBottomSheetScreenForEdit(
                                  productModel: OrderProductModel(
                                    ...
                                    cheapPrice: productModel.cheapPrice,
                                    expensivePrice: productModel.expensivePrice,
                        ...
                        showModalBottomSheet<void>(
                          ...
                          builder: (BuildContext context) {
                            return ProductDetailBottomSheetScreenForEdit(
                              productModel: OrderProductModel(
                                isExpensive: productPriceState.isExpensive,
                                expensivePrice: productModel.expensivePrice,
                                cheapPrice: productModel.cheapPrice,
                                count: 0,
                                mfgDate: productModel.mfgDate ?? "",
                        ...
                        if (productModel.productActive)
                          Builder(
                            builder: (context) {
                              ...
                              if (exists.isNotEmpty) {
                                for (var element in products) {
                                  OrderProductModel cartModel = products
                                      .firstWhere(
                                        (element) =>
                                            element.productId ==
                              ...
                              return InkWell(
                                ...
                                child: Container(
                                  ...
                                  child: Text(
                                    '${NumberFormat.decimalPattern('uz_UZ').format(productPriceState.isExpensive ? productModel.productPrice + productModel.expensivePrice : productModel.productPrice + productModel.cheapPrice)} ${tr("sum")}',
                                    style: TextStyle(
                                      fontSize: 14.sp,
