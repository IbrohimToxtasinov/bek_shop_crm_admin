...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<ChangeProductsCostCubit, ChangeProductsCostState>(
      buildWhen: (previous, current) => current is GetProductsCostSuccess,
      builder: (context, productPriceState) {
        if (productPriceState is GetProductsCostSuccess) {
          return BlocProvider(
            create:
                (context) => ProductsPdfBloc(context.read<ProductRepository>()),
                        ...
                        child: Column(
                          children: [
                            SwitchListTile(
                              ...
                              value: productPriceState.isExpensive,
                              onChanged: (value) {
                                context
                                    .read<ChangeProductsCostCubit>()
                                    .changeProductsCost(
                                      productsExpensive: value,
                                    );
                              },
                            ),
                          ],
                        ...
                        children: [
                          IconButton(
                            ...
                            onPressed:
                                () => Navigator.pushNamed(
                                  context,
                                  AppRouterNames.globalSearchProducts,
                                ),
                          ),
                          IconButton(
                            ...
                            onPressed:
                                () => Navigator.pushNamed(
                                  context,
                                  AppRouterNames.addCategoryRoute,
                                ),
                            icon: SvgPicture.asset(
                              AppIcons.add,
                              width: 24.w,
                          ...
                          IconButton(
                            ...
                            onPressed: () {
                              context.read<ProductsPdfBloc>().add(
                                GenerateAndSharePdfEvent(share: false),
                              );
                            },
                          ),
                          IconButton(
                            ...
                            onPressed: () {
                              context.read<ProductsPdfBloc>().add(
                                GenerateAndSharePdfEvent(share: true),
                              );
                            },
                          ),
                        ],
