...
//       emit(
//         state.copyWith(hasInternet: true, connectivityResult: result),
//       );
//     } else {
//       emit(
//         state.copyWith(hasInternet: false, connectivityResult: result),
//       );
//     }
//
//     debugPrint("HAS INTERNET INITIAL CHECK:${state.hasInternet}");
//     debugPrint("HAS INTERNET INITIAL STATES:$result");
//   }
//
//   _checkConnectivity(
